...
class ActionContentAssistProcessorTest extends CompletionComputerTest {
  ...
  def simple_package_completion_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simpl#" }
  ...
  def simple_module_completion_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.#" }
  ...
  def simple_method_completion_with_no_parens_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.f#" }
  ...
  def simple_method_completion_with_empty_parens_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.ba#" }
  ...
  def simple_method_completion_with_one_string_argument() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.withStr#" }
  ...
  def simple_method_completion_with_one_int_argument() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.withInt#" }
  ...
  def simple_val_completion_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.bu#" }
  ...
  def simple_lazy_val_completion_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.lazyB#" }
  ...
  def simple_var_completion_for_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.bo#" }
  ...
  def no_completion_for_non_action_method_scala_controller() {
    val route = RouteCompletionFile { "GET / controllers.simple.SimpleScalaPlayApp.nonActionMe#" }
  ...
  def completion_for_scala_object_not_extending_controller() {
    val route = RouteCompletionFile { "GET / controllers.scala.AppNo#" }
  ...
  def action_completion_for_scala_object_not_extending_controller() {
    val route = RouteCompletionFile { "GET / controllers.scala.AppNotExtendingController.#" }
  ...
  def no_completion_for_non_action_method_in_scala_class_iff_prefixed_by_@() {
    val route = RouteCompletionFile { "GET / @controllers.scala.AppClass.nonActionM#" }
  ...
  def simple_completion_for_java_controller() {
    val route = RouteCompletionFile { "GET / controllers.java.App#" }
  ...
  def action_completion_for_java_controller() {
    val route = RouteCompletionFile { "GET / controllers.java.Application.he#" }
  ...
  def no_completion_for_static_method_with_wrong_return_type_in_java() {
    val route = RouteCompletionFile { "GET / controllers.java.Application.nonActionMeth#" }
  ...
  def no_completion_for_static_fields_for_java_controller() {
    val route = RouteCompletionFile { "GET / controllers.java.Application.fieldIsNotValidAct#" }
  ...
  def completion_for_NON_static_method_for_java_controller_iff_prefixed_by_@() {
    val route = RouteCompletionFile { "GET / @controllers.java.Application.#" }
  ...
  def method_completion_with_one_string_argument_in_java_controller() {
    val route = RouteCompletionFile { "GET / controllers.java.Application.withIntegerAr#" }
  ...
  def inherited_method_completion_in_scala_controllers() {
    val route = RouteCompletionFile { "GET / controllers.scala.SubAppClass.actionM#" }
  ...
  def inherited_accessor_completion_in_scala_controllers() {
    val route = RouteCompletionFile { "GET / controllers.scala.SubAppClass.actionV#" }
  ...
  def completion_for_scala_controller_method_with_mangled_name() {
    val route = RouteCompletionFile { "GET / controllers.scala.ActionWithMangledName.#" }
  ...
  def no_completion_for_scala_trait() {
    val route = RouteCompletionFile { "GET / controllers.scala.Trait#" }
  ...
  def no_completion_for_action_method_in_scala_trait() {
    val route = RouteCompletionFile { "GET / controllers.scala.TraitApp#" }
  ...
  def no_completion_for_scala_abstract_class() {
    val route = RouteCompletionFile { "GET / controllers.scala.Abstract#" }
  ...
  def no_completion_for_action_method_in_scala_abstract_class() {
    val route = RouteCompletionFile { "GET / controllers.scala.AbstractApp.#" }
  ...
  def no_completion_for_non_concrete_public_action_methods_in_scala() {
    val route = RouteCompletionFile { "GET / controllers.scala.MembersVisibility.#" }
  ...
  def completion_for_java_abstract_controller_class() {
    val route = RouteCompletionFile { "GET / controllers.java.Abstract#" }
  ...
  def completion_for_static_action_methods_in_java_abstract_class() {
    val route = RouteCompletionFile { "GET / controllers.java.AbstractApplication.#" }
